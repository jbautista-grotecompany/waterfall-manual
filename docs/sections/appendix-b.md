...
| Load cell wire terminals | Load cell signal cable termination points. |
...
| Network switches | Ethernet network switches. |
...
| PLC and I/O | Programmable Logic Controller and associated input/output modules. |
...
| Power supply | 24VDC control power supply. |
...
| Wire terminals | Control and power wiring termination blocks. |